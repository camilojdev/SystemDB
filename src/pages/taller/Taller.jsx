...
import ModalCreditoProveedor from '../compras/ModalCreditoProveedor'
import ModalDetalleEntrada from '../compras/ModalDetalleEntrada'
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-3xl font-bold text-heading">Compras</h1>
          <p className="text-muted text-base mt-1">Entradas, proveedores y créditos</p>
        </div>
        {tab === 'entradas' && (
          <button onClick={() => setModalEntrada(true)}
            className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-slate-700">
                {entradas.map((e) => (
                  <tr key={e.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                    ...
                    <td className="px-6 py-4 text-sm text-muted">{e.proveedorNombre || '—'}</td>
                    <td className="px-6 py-4 text-sm text-muted">{e.numeroFacturaProveedor || '—'}</td>
        ...
        <div className="space-y-4">
          ...
          {creditos.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-slate-700 flex items-center justify-center">
